...
def send_email(*args):
    ...
    server.starttls()
    server.login('shivasunny451@gmail.com', '7095651014Shiva')
    email = EmailMessage()
    email['From'] = 'shivasunny451@gmail.com'
    email['To'] = args[0]
...
email_list = {"shiva":"vshivasankarareddy849@gmail.com","bharadwaj":"Bharadwajvemuri2000@gmail.com","personal":"shivasunny451@gmail.com"}
def get_email_info():
...
if __name__=='__main__':
    ...
    while True:
        ...
        if 'wikipedia' in statement:
            ...
            speak("I was built by Shiva")
            print("I was built by Shiva")
